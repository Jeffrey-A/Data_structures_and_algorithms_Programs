...
class Deck(object):
    ...
    def __init__(self):
        ...
        # are O(1) or theta(1), because of the len() function efficiency is O(1) .
...
def test():
    ...
    d.addTop(10,'s') #adding this card to the top of the deck
    print("d.addTop(10,'s')",d.cards[0])
    print()

    
    print("################Testing AddBottom################")
    d.addBottom(6,'c') #adding this card to the end of the deck
    print("d.addBottom(6,'c')",d.cards[d.deck_size-1])
    print()

    
    print("################Testing AddRandom################")
    d.addRandom(14,'h')#adding this card to a random place in the deck
